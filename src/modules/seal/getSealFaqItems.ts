...
The moment the Seal Engine launched, the exit fee rate was set to 5% of the value of the MKR or SKY tokens that you have sealed, with a planned 1% increase every 6 months thereafter until it reaches the long-term fee rate of 15%.`
  },
  {
    ...
    answer: `When you hold MKR or SKY (sealed or unsealed), you also hold the right to participate in Sky ecosystem governance voting. That means that you have the ability to contribute to the decentralised ecosystem decision-making process, which occurs through on-chain voting.

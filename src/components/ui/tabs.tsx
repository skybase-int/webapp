...
const tabsTriggerVariants = cva('', {
  variants: {
    variant: {
      ...
      icons:
        'text-xs text-textSecondary flex flex-col gap-1 items-center justify-center px-2 py-2.5 rounded-xl w-[72px] md:w-16 data-[state=active]:text-text bg-primary !border-0 [--gradient-opacity:0%] data-[state=active]:[--gradient-opacity:100%] data-[state=active]:!border hover:[--gradient-opacity:50%] transition-gradient-opacity duration-250 ease-out-expo relative'
    },
    position: {
      default: '',
